(function () {
  const state = {
    lang: localStorage.getItem("oral-b-clean-lang") || "zh"
  };
  ...
  function renderProductDetail() {
    ...
    document.title = `${productName(product)} | Oral B`;
      ...
      <section class="detail-hero">
        <div class="detail-copy">
          ...
          <div class="detail-actions">
            <strong>${product.price}</strong>
            <a class="primary-btn" href="mailto:hello@oral-b-clean.example">${t("detail.contact")}</a>
          </div>
  ...
  function applyLanguage(lang) {
    state.lang = lang;
    localStorage.setItem("oral-b-clean-lang", lang);
